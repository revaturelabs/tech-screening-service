...
@Controller
@ApiIgnore
@RequestMapping(value = ScreeningSwaggerHomeController.SWAGGER_HOME)
public class ScreeningSwaggerHomeController extends Swagger2Controller {
	
	public static final String SWAGGER_HOME = "/users/documentation";
	
	public ScreeningSwaggerHomeController(Environment environment, DocumentationCache documentationCache,
